...
<%
	...
	if(bg != null && bg.equals("true")) {
		...
		if(name == null || !name.equals("admin")) {
			...
			session.setAttribute("loginbg", "true");
    ...
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <div class="panel loginbox">
                ...
                <center><font color="red" size="1"><%= err %></font></center>
                <div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
                    ...
                    <div class="form-group">
                        <div class="field">
                            <input type="text" class="input input-big" name="code" placeholder="填写右侧的验证码" data-validate="required:请填写右侧的验证码,compare#==6982:请输入正确的验证码" />
